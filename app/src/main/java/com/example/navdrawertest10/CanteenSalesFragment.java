...
public class CanteenSalesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.canteen_sales_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new MyAdapter_Canteen_Sales(CanteenSalesFragment.this.getActivity(), list);
