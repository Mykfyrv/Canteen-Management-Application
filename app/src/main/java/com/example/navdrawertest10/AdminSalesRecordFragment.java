...
public class AdminSalesRecordFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.admin_sales_record_fragment, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new MyAdapter_Canteen_Sales(AdminSalesRecordFragment.this.getActivity(), list);
        recyclerView.setAdapter(adapter);

        Bundle dateBundle = this.getArguments();
        newDate = dateBundle.getString("date");
        Query root = FirebaseDatabase.getInstance().getReference().child("H-Record").child(newDate);
