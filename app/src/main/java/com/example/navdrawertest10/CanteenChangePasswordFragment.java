...
public class CanteenChangePasswordFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.canteen_change_password_fragment, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        change =(Button) view.findViewById(R.id.changeCanteen_pass);
        cPassword = (EditText) view.findViewById(R.id.Canteen_pass);
        nPassword = (EditText) view.findViewById(R.id.enterCTPassword);
        cfPassword = (EditText) view.findViewById(R.id.confirmCTPassword);
        aprogressBar = (ProgressBar) view.findViewById(R.id.CTprogressBar);
        cancel = (Button) view.findViewById(R.id.cancelCanteen_pass);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CanteenChangePasswordFragment.this.getActivity(), ZCanteenDrawer_MainAct.class));
            }
        });
                        ...
                        for(DocumentSnapshot data : task.getResult()) {
                            ...
                            if (a.equalsIgnoreCase("Admin_canteen")) {
                                if (!CPassword.equals(b)) {
                                    ...
                                    db.collection("admin_accounts").document("ADMIN-CANTEEN").update("password", NPassword).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(CanteenChangePasswordFragment.this.getActivity(), "Password Change", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(CanteenChangePasswordFragment.this.getActivity(), ZCanteenDrawer_MainAct.class));
                                            } else {
                                                Toast.makeText(CanteenChangePasswordFragment.this.getActivity(), "Error : " + task.getException(), Toast.LENGTH_SHORT).show();
                                                aprogressBar.setVisibility(View.GONE);
                                            }
                                        }
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(CanteenChangePasswordFragment.this.getActivity(), e.getMessage(), Toast.LENGTH_SHORT).show();
                                            aprogressBar.setVisibility(View.GONE);
                                        }
                                    });
                                }
